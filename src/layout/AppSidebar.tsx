...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    name: "Perfil",
    subItems: [
      { name: "Información", path: "/profile" },
      { name: "Pagos", path: "/profile/payments" },
    ],
  },
];
        ...
        <Link to="/dashboard" className="flex items-center gap-3">
          ...
          {(isExpanded || isHovered || isMobileOpen) && (
            <span className="text-xl tracking-tight leading-none">
              <span className="font-extrabold text-gray-800 dark:text-white">Place</span><span className="font-extrabold text-brand-500">Hub</span>
            </span>
          )}
        </Link>
      </div>
